...
@interface JLMineHeaderInSectionView()
/** 喜欢的礼物 */
...
@implementation JLMineHeaderInSectionView
...
- (void)setUp
{
    ...
    [self addBtnToView:self.likeBtn title:@"喜欢的礼物" tag:0];
    self.strategyBtn = [UIButton new];
    [self addBtnToView:self.strategyBtn title:@"喜欢的攻略" tag:1];
...
{
    JLMineHeaderInSectionView *selectView = [[self alloc] init];
    return selectView;
}
...
//有代理时，点击按钮
- (void)setDelegate:(id<JLMineHeaderInSectionViewDelegate>)delegate
{
    _delegate = delegate;
